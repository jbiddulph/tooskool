"""
Django settings for tooskool project.
...
NPM_BIN_PATH = "/Users/johnbiddulph/.nvm/versions/node/v21.2.0/bin/npm"
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR / 'tooskool' / 'templates'),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'tooskool.wsgi.application'
